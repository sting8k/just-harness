...
**Purpose:** Map every file and capability in `just-harness` to a recognized framework so we can evaluate coverage, attribute failures, and do ablation studies.
