...
| --- | --- | --- | --- | --- | --- |
| 1 | Task specification | Covered | `AGENTS.md`, `docs/FEATURE_INTAKE.md`, `docs/ARTIFACTS.md`, `docs/templates/story.md`, `docs/templates/spec-intake.md`, `docs/templates/high-risk-story/*`, `docs/stories/*`, `intake` table, `story` table | Requests are classified by type and lane, then mapped to a bounded work packet before implementation; normal and high-risk work have templates and durable story rows. | Keep work packets synchronized with future product docs and durable proof records. |
